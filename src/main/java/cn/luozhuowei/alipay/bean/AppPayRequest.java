 ...
 */
public class AppPayRequest extends AlipayBaseBean {
	 ...
	 * @desc 外部商户APP唤起快捷SDK创建订单并支付
	 */
	public AppPayRequest(String outTradeNo, Integer totalAmount, String subject) {
	 ...
	 * @desc 外部商户APP唤起快捷SDK创建订单并支付
	 */
	public AppPayRequest(String outTradeNo, Double totalAmount, String subject) {
	 ...
	 * @desc 外部商户APP唤起快捷SDK创建订单并支付
	 */
	public AppPayRequest(String outTradeNo, String totalAmount, String subject) {
		this();
